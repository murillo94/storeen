...
describe('Tab', () => {
  ...
  test('should have children and default values', () => {
    const { getByRole } = render(<Tab>{content}</Tab>);
  ...
  test('should have type submit', () => {
    const { getByRole } = render(<Tab type="submit">{content}</Tab>);
  ...
  test('should have text and icon', () => {
    const { getByRole } = render(<Tab text="im button" icon="plus" />);
  ...
  test('should be disabled', () => {
    const { getByRole } = render(<Tab disabled>{content}</Tab>);
  ...
  test('should have custom style', () => {
    const { getByRole } = render(
      <Tab customStyle={{ margin: '10px', backgroundColor: 'red' }}>
        {content}
      </Tab>
    );
  ...
  test('should have click', () => {
    ...
    const { getByRole } = render(<Tab onClick={onClick}>{content}</Tab>);
  ...
  test('should have minimal theme', () => {
    const { getByRole } = render(<Tab appearance="minimal">{content}</Tab>);
  ...
  test('should have negative theme', () => {
    const { getByRole } = render(<Tab appearance="negative">{content}</Tab>);
  ...
  test('should have positive theme', () => {
    const { getByRole } = render(<Tab appearance="positive">{content}</Tab>);
