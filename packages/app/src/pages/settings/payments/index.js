...
import useSettingsPayments from '@app/containers/useSettingsPayments';
      ...
      >
        <Stack>
            ...
            disclosure={
              <Disclosure isVisible={mercadoPago.active}>
                <Paragraph color="muted" marginBottom={4}>
                  Informe o endereço de e-mail que você usou para criar sua
                  conta do Mercado Pago. Mais informações sobre como conectar o
                  Mercado Pago podem ser encontradas aqui.
                </Paragraph>
                <Input
                  type="email"
                  labelText="Email"
          ...
          >
            <Inline>
              <ImageDescription
                src={require('@app/public/images/payments/mercadopago.svg')}
          ...
          <ContainerPayment
            disclosure={
              <Disclosure isVisible={wirecard.active}>
                <Paragraph color="muted" marginBottom={4}>
                  Informe o endereço de e-mail que você usou para criar sua
                  conta da Wirecard. Mais informações sobre como conectar o
                  Wirecard podem ser encontradas aqui.
                </Paragraph>
                <Input
                  type="email"
                  labelText="Email"
          ...
          >
            <Inline>
              <ImageDescription
                src={require('@app/public/images/payments/wirecard.svg')}
                alt="Wirecard logo"
          ...
          <ContainerPayment
            disclosure={
              <Disclosure isVisible={pagSeguro.active}>
                <Paragraph color="muted" marginBottom={4}>
                  Informe o endereço de e-mail que você usou para criar sua
                  conta da PagSeguro. Mais informações sobre como conectar o
                  PagSeguro podem ser encontradas aqui.
                </Paragraph>
                <Input
                  type="email"
                  labelText="Email"
          ...
          >
            <Inline>
              <ImageDescription
                src={require('@app/public/images/payments/pagseguro.svg')}
                alt="PagSeguro logo"
          ...
          <ContainerPayment
            disclosure={
              <Disclosure isVisible={paypal.active}>
                <Paragraph color="muted" marginBottom={4}>
                  Informe o endereço de e-mail que você usou para criar sua
                  conta da PayPal. Mais informações sobre como conectar o PayPal
          ...
          >
            <Inline>
              <ImageDescription
                src={require('@app/public/images/payments/paypal.svg')}
                alt="PayPal logo"
                description="PayPal"
                width="32px"
                height="32px"
