      ...
      <Box as="section" paddingX={3} paddingY={4}>
        <Stack space="xlarge" sx={{ textAlign: 'justify' }}>
          <Stack space="xsmall">
            ...
            <Stack>
              <Paragraph>
                Quando você cria uma conta na Storeen, capturamos informações
                como nome do responsável, e-mail, telefone, endereço, CNPJ. Além
                disso, também são armazenados dados da loja como nome de
                produto, foto, preço, descrição, estoque, entre outros dados.
              </Paragraph>
              <Paragraph>
                O sistema também armazena dados cadastrais, preferências e
                histórico de compra de clientes que se cadastraram nas
                respectivas lojas. Esses dados apenas podem ser consultados pelo
                lojista ou pelo próprio cliente, mediante identificação por
                senha.
              </Paragraph>
            </Stack>
          </Stack>
          ...
          <Stack space="xsmall">
            ...
            <Stack>
              <Paragraph>
                ...
                como comunicados da ferramenta, changelog, condições e
                políticas, informações sobre o pacote do plano adquirido, entre
                outras. Como estas informações são importantes para a sua
                interação com a storeen, você não poderá optar por não receber
              ...
              <Paragraph>
                ...
                análise de dados e pesquisas para aprimorar os produtos,
                serviços e comunicações com os nossos clientes. Nesses casos,
                você poderá optar por receber ou não essa comunicação.
              </Paragraph>
              <Paragraph>
              ...
              <Paragraph>
                Nosso site poderá conter links para outros sites não
                pertencentes à Storeen. Nesses casos não seremos responsáveis
                pelas ações desses sites, para os quais não será aplicável a
              ...
              <Paragraph>
                ...
                decorrência das vendas realizadas através do Site, as quais
                sempre pertencerão aos Usuários.
              </Paragraph>
            </Stack>
          </Stack>
          <Stack space="xsmall">
            ...
            <Stack>
              <Paragraph>
                Você também é responsável pela segurança e sigilo das suas
                senhas e/ou informações confidenciais. Dessa forma,
                recomendamos:
              </Paragraph>
              <Paragraph>
                Ao acessar a Internet busque sempre conhecer a política de
                privacidade do site que você está acessando. Use senhas
                complexas que dificultem sua detecção por outras pessoas, senhas
                simples são facilmente quebradas. Nunca forneça sua senha a
                ninguém e procure criar senhas novas periodicamente. Crie
                acessos distintos para os funcionários acessarem o painel
                administrativo da sua loja. Você poderá excluí-los quando
                necessário. Se você tiver qualquer dúvida com relação à nossa
