      ...
      <Stack space="xlarge" sx={{ textAlign: 'justify' }}>
        <Stack space="xsmall">
          ...
          <Stack>
            ...
            <Paragraph>
              Ao criar sua loja na Storeen, iniciará automaticamente nosso tour
              virtual, este que certamente vai te ajudar com os primeiros
              passos.
            </Paragraph>
          </Stack>
        </Stack>
        <Stack space="xsmall">
          ...
          <Paragraph>
            Na Storeen não importa o tamanho do seu negócio, nós acreditamos na
            igualdade e estamos prontos para atender você. Nós temos apenas um
            único preço.
          </Paragraph>
        </Stack>
        <Stack space="xsmall">
          ...
          <Stack>
            ...
            <Paragraph>
              ...
              problemas de ordem tributária no futuro. Uma vez que para gerar a
              nota fiscal da venda é necessário o CNPJ. Um opção seria abrir uma
              empresa{' '}
              <Anchor
            ...
            <Paragraph>
              E é claro que possuir um CNPJ tende também a ajudar na questão de
              passar credibilidade para seu cliente, pois demostra que tudo está
        ...
        <Stack space="xsmall">
          ...
          <Paragraph>
            ...
            especialmente e meticulosamente desta questão para garantir que você
            não vá ter problemas com fraude no pagamento (por isso trabalhamos
            somente com gateways seguros) e garantimos dados criptografados e
            uma navegação segura para você e seus clientes com um certificado
            SSL.
          </Paragraph>
        </Stack>
        <Stack space="xsmall">
        ...
        <Stack space="xsmall">
          ...
          <Stack>
            <Paragraph>
              ...
              entendimento e muito intuitiva. Você mesmo consegue criar sua loja
              virtual, escolher e personalizar um tema diretamente no painel
              administrativo da sua loja.
            </Paragraph>
            <Paragraph>
        ...
        <Stack space="xsmall">
          ...
          <Stack>
            <Paragraph>
              ...
              subdomínio gratuito e o endereço da sua loja ficará nesse formato:
              nomedasualoja.storeen.com.br.
            </Paragraph>
            <Paragraph>
              Porém caso queira utilizar um domínio próprio (exemplo:
              nomedasualoja.com.br) você vai precisar adquiri-lo por exemplo no{' '}
              <Anchor
              ...
              planos solicitamos que entre em contato diretamente com eles. Nós
              da Storeen não realizamos venda de domínios próprios.
            </Paragraph>
          </Stack>
        </Stack>
        <Stack space="xsmall">
          ...
          <Stack>
            ...
            <Paragraph>
              Importante! Você nunca irá conseguir criar duas lojas com o mesmo
              e-mail.
            </Paragraph>
          </Stack>
        </Stack>
        <Stack space="xsmall">
          ...
          <Stack>
            <Paragraph>
              ...
              tradução livre) é o código que identifica um determinado produto e
              auxilia no controle e manutenção do estoque da sua loja.
            </Paragraph>
            <Paragraph>
              O código SKU é usado para diferenciar os produtos de acordo com
              suas características específicas, como por exemplo: Tamanho Forma
              Cor Marca e etc.
            </Paragraph>
            <Paragraph>
